...
const UsersList = () => {
  ...
  return (
    <HelmetProvider>
      ...
      <div className='className="flex relative flex-col lg:flex-row bg-gray-200 lg:pl-24 lg:py-10 h-screen"'>
        ...
        <div className="overflow-x-auto lg:w-[80%] w-[90%] lg:min-h-[90vh] relative mt-24 ml-5  lg:mt-0  h-4/5 pb-10 bg-white shadow-xl  lg:ml-72  border-0 border-gray-400  rounded-3xl flex flex-col items-center font-sans">

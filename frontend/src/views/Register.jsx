...
const Register = () => {
  ...
  const registerUser = async (e) => {
    ...
    try {
      ...
      navigate('/verify-otp', { state: { user: registeredUser } });
    } catch (error) {
      setLoading(false)
      console.log(error)
    }
          ...
          <div className="  bg-white w-[80%] py-5 mt-20 mb-20 h-auto rounded-2xl shadow-xl text-4xl">
            <div className="w-full  flex flex-col gap-4">
              ...
              <div className="lg:pl-5 lg:mt-5">
                <h1 className="lg:text-6xl font-semibold text-center">Register</h1>


              </div>
            </div>
            <form action="" method="post" onSubmit={registerUser} className="w-full lg:mt-5 mt-5 flex flex-col items-center justify-center gap-y-5">
